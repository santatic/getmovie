...
class filmDecrypter:
	def __init__(self, param1, param2):
		...
		self.Nb = int(param2 / 32)
		self.Nk = int(param1 / 32)
	...
	def keyExpansion(self, param1):
		_loc4_ = None
		_loc2_ = 0
		self.Nk = int(self.keySize / 32)     # =6, what if this was 5
		self.Nb = int(self.blockSize / 32)
		_loc3_ = []
	...
	def packBytes(self, param1):
		...
		_loc3_ = 0
		while(_loc3_ < len(param1)):
			_loc2_[0][int(_loc3_ / 4)] = param1[_loc3_]
			_loc2_[1][int(_loc3_ / 4)] = param1[_loc3_ + 1]
			_loc2_[2][int(_loc3_ / 4)] = param1[_loc3_ + 2]
			_loc2_[3][int(_loc3_ / 4)] = param1[_loc3_ + 3]
			_loc3_ = _loc3_ + 4
		return _loc2_
...
def decryptKey(param1):
	_local_2 = filmDecrypter(198,128)
